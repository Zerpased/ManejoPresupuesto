...
namespace Manejo_Presupuesto.Controllers
{
    ...
    public class TransaccionesController: Controller
    {
        ...
        public async Task<FileResult> ExportarExcelPorAño(int año)
        {
            ...
            var nombreArchivo = $"Manejo_Presupuesto - {fechaInicio.ToString("yyyy")}.xlsx";
            return GenerarExcel(nombreArchivo, transacciones);
        }
        ...
        public async Task<FileResult> ExportarExcelTodo()
        {
            ...
            var nombreArchivo = $"Manejo_Presupuesto - {DateTime.Today.ToString("dd-MM-yyyy")}.xlsx";
            return GenerarExcel(nombreArchivo, transacciones);
        }
        ...
        {
            DataTable dataTable = new DataTable("Transaciones");
